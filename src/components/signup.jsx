            ...
            <section className="relative">
                <div className="bg-[#1F3A1F] h-[490px] w-[600px] bg-opacity-75 rounded-[12px] relative flex mt-[80px] justify-around shadow-radial-sm-less-noticeable">
                    ...
                    <div className="relative z-10 w-[750px] h-[87px] flex justify-around">
                        ...
                        <div className="bg-[#1F3A1F] h-[490px] w-full bg-opacity-75 rounded-[12px]">
                            ...
                            <div className="flex justify-around items-center mt-7">
                                <p className="font-thin text-[#7d7f7d] text-[14px]">Already have an account?<Link to={'/login'}><span className="text-[#FDC800]"> login</span></Link></p>
                            </div>
                        </div>
